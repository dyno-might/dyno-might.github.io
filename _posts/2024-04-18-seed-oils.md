...
And I wouldn't be shocked if one of the suggested mechanisms for seed oil turns out to be valid. I wouldn't be surprised *at all* if some mechanism turned out to part of a larger, more complicated story.
