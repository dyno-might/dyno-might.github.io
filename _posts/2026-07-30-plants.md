...
Meanwhile, plants turn carbon dioxide into oxygen through photosynthesis, i.e. the chemical [reaction](https://en.wikipedia.org/wiki/Photosynthetic_efficiency) of (6 water molecules) + (6 carbon dioxide molecules) + (energy) → (1 glucose molecule) + (6 oxygen molecules). The minimum energy physically needed to convert 1 mole of carbon dioxide into glucose and oxygen via the above reaction is ~477 kilojoules.
