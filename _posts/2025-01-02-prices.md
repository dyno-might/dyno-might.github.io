...
DEMAND'(P)
 = d/dP U(P) × SUPPLY(U(P) × P)
 = U'(P) × SUPPLY(U(P) × P) + U(P) × d/dP SUPPLY(U(P) × P)
 = U'(P) × SUPPLY(U(P) × P) + U(P) × SUPPLY'(U(P) × P) × d/dP(P × U(P))
 = U'(P) × SUPPLY(U(P) × P) + U(P) × SUPPLY'(U(P) × P) × (U(P) + P U'(P))
...
DEMAND'(P)
 = U'(P) × SUPPLY(P) + SUPPLY'(P) × (1 + P U'(P))
 = U'(P) × (SUPPLY(P) + P SUPPLY'(P))  + SUPPLY'(P)
...
W'(P)
 = U(P) + P×U'(P)
 = 1 + P×(DEMAND'(P) - SUPPLY'(P)) / (SUPPLY(P) + P SUPPLY'(P))
 = (SUPPLY(P) + P×SUPPLY'(P) + P×DEMAND'(P) - P×SUPPLY'(P)) / (SUPPLY(P) + P SUPPLY'(P))
 = (SUPPLY(P)  + P×DEMAND'(P)) / (SUPPLY(P) + P SUPPLY'(P))
 = (SUPPLY(P)/P  + DEMAND'(P)) / (SUPPLY(P)/P + SUPPLY'(P))
 = (S/P  + DEMAND'(P)) / (S/P + SUPPLY'(P))
...
So really, I think Massachusetts' policy is worse than bad—it's a [mistake](https://www.ft.com/content/5fe0ca15-2f62-488b-8163-3a31e15b3b0e). Riders pay more and get fewer rides. And for what? Basically to pay drivers to sit around, spending energy, wasting time, and increasing traffic. Healthy, ambitious societies do not do that.