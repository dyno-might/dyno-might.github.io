...
I'm not sure exactly what to make of this. It's *possible* that these experiments are wrong, or that Mexican Coke is made with sucrose that somehow breaks down into fructose and glucose during manufacturing. [*update*: This is probably the explanation: sucrose can be ["inverted"](https://en.wikipedia.org/wiki/Inverted_sugar_syrup#Production) into fructose and glucose by heat and/or acidity.] But it seems more likely that Mexican Coke has been made with corn syrup for a long time, despite whatever it says on the label.
...
Overall, I think there's no evidence that the Mexican version truly tastes any better. If it does, it's a placebo from being told it's a special import or maybe just the fact that it comes in adorable little glass bottles.
...
If you must drink cola, drink *diet* cola, sweetened with aspartame. As far as we know from current science, aspartame has basically [zero negative effects](https://www.webmd.com/diet/what-to-know-about-aspartame#1). For example, this recent [meta-analysis](https://doi.org/10.1080/10408398.2017.1304358) found no significant effects on blood glucose levels, insulin levels, cholesterol, triglycerides, body weight, or energy intake.  There was a tiny effect on HDL cholesterol, but that's "good" cholesterol, and the effect was to increase it. It's certainly possible there's some risk that hasn't been established yet, but if so, it's an order of magnitude less than you get from any kind of sugar. Water is safer than diet cola, but diet cola is *much* safer than real cola.
