...
There are some hypothesized effects: For example, glucose seems to cause an insulin spike, but fructose doesn't. It's unclear if that is good or bad---the insulin spike might make you feel full and stop eating. Or there are some suggestion that the liver might produce fat when metabolizing glucose.
