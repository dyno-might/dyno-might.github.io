...
In 2004 Samsonite introduced the four-wheeled suitcase. In these, each wheel spins on a [caster](https://en.wikipedia.org/wiki/Caster) so you can push the suitcase vertically without the grueling labour of holding it up.
