...
When determining the number of weeks, most places count since the start of the last menstrual period (LMP). This is a little odd, since one can't actually become pregnant until around 2 weeks after this, but I suppose it makes counting easier. A couple places define limits with respect to conception (Belgium, Germany---contact me if you are aware of others). In my graphic, I added two weeks to any limit defined with respect to conception.
