...
## Abortion on-demand after the second trimester is nonexistent outside the United States
...
Aside from Poland, the only other places with similar restrictions are Liechtenstein, Monaco, Malta, and Andorra---a bunch of heavily Catholic microstates. These countries have a combined population of around 680k people, 44 times smaller than the state of Texas. If [El Paso](https://worldpopulationreview.com/states/cities/texas) was a country, it alone would have a larger population.

If you take all the people in the rich world who live somewhere where abortion is (almost fully banned), currently almost all of them live in the United States.

## Summary

Rich countries are not monolithic. However, outside the US and a few microstates, they vary in a limited range: Abortion is available on-demand (de-jour or de-facto) for between 12 and 24 weeks, plus later under varying exceptional circumstances.
