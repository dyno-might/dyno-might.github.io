...
tags: science
description: "If you wanted to invent nuclear weapons from scratch, how might you go about that?"
permalink: /nukes/
...
Unfortunately, it's hard to find atoms that do much spontaneous fission. plutonium-240 atom decays on average after 6569 years, and when that happens, there's only a 0.0005% probability of fission, rather than α decay or whatever.
...
Notes:
* The [Zippe-type centrifuge](https://en.wikipedia.org/wiki/Zippe-type_centrifuge) was actually invented by Austrian and German scientists captured by the USSR after WWII.
* In reality, you'd never obtain pure 100% U-235. In practice, people use something like 90% U-235, which has a larger critical mass. But you'd also probably put a metal like beryllium around the mass to reflect the neutrons back in, which [dramatically decreases](https://www.princeton.edu/~aglaser/lecture2007_makingheu.pdf) the critical mass.
* Apparently it's legal in the US to own as much uranium ore as you want, but you [aren't allowed](https://www.quora.com/How-much-uranium-ore-can-you-legally-own-without-a-license-How-much-yellowcake-can-you-legally-own-without-a-license-What-would-be-a-safe-way-to-store-either-of-these-for-a-collection/answer/Carl-Willis-2) to posses more than 1.5 kg of yellowcake.
* These days, the technique of mining and then refining uranium ore is becoming obsolete. Instead, [in-situ leach mining](https://en.wikipedia.org/wiki/In_situ_leach#Uranium) is used where chemicals are added directly to the ground to dissolve the uranium and then only that liquid is pumped out of the ground.
* U-235 and U-238 may not be 100% chemically identical---a [project in France](https://en.wikipedia.org/wiki/In_situ_leach#Uranium) is working on a chemical separation method that would be an alternative to centrifuges.
* Of course, centrifuges won't actually recover all of the 0.7% of U-235 in yellowcake. But apparently it is possible to recover [the majority](https://world-nuclear.org/getmedia/3d71ded5-7e0e-434b-82a9-05c801c70ef5/uranium-enrichment-uses.png.aspx) of it.
...
* My estimate for the amount of water you'd need to process:
  * You need 7429 kg of uranium
  * So you need a total of 7429 kg U × (3.03e8 kg water / kg U) =  2.250987e12 kg of water
  * Water is 1000 kg / m^3
  * So that is 2.250987e12 kg of water × (1 m^3 water / 1000 kg water) = 2.250987e9 m^3 water
  * 2.250987e9 m^3 = (1310.6 m)^3
