...
3. Have I mentioned that heritability depends on society? And that heritability changes when society changes? And that heritability is [just a ratio](https://dynomight.net/heritable/) and you should stop trying to make it be a non-ratio because only-ratio things cannot be non-ratios? This is a nice reminder.
...
> Heritability of intrinsic human lifespan is about 40% when extrinsic mortality is adjusted to modern levels, according to our simulation.
