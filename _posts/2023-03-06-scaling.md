...
This post assumes some vague familiarity with LLMs. If you don't have that (is anyone out there?) you probably want to read [your friend the language model](https://dynomight.net/llm-friend/) first.
