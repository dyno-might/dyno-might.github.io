---
layout: post
title: "First-principles on AI progress"
image: /img/scaling/stuttgart.jpg
tags: science, economics
description: "behold scaling laws plus arithmetic"
excerpt: ""
permalink: /scaling/
...
But I think I was wrong. If you want to know what's going to happen with AI, we *can* do better (or at least the inside view is worth considering). We can:

1. Use scaling laws to guess how much LLMs will get better at predicting words if you add more computational power or more data.
...
<details markdown="1">
<summary>
A lot. As a first exercise, let's imagine that you had infinite compute. You can train an *infinitely* large model, only on a finite amount of data. How good would it be? Well, go plug <var>N=∞</var> into the scaling law. If you have <var>D</var> tokens, you should expect a total error of <var>E(∞,D)</var>. Here's what that looks like compared to a few well-known models.
</summary>
...
Thanks to [Andrew Conner](https://andrewconner.com/), Tristan Homsi, DB, other DB
...
<details markdown="1" style="margin-left:20pt;" id="data-estimates">
