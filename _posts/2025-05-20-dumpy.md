...
It's just a single file with around 700 lines. I'm leaving it as a single file because I want to stress that **this is just something I hacked together in the service of this rant**. I wanted to show that I'm not totally out of my mind, and that doing all this is actually pretty easy. (It's around 700 lines.)
