...
with dp.Range(N - window + 1) as i:
    ...
    # Note: B_dumpy[i] = dp.mean(A[i:i+window])
...
It's just a single file with less than 1000 lines. I'm leaving it as a single file because I want to stress that **this is just something I hacked together in the service of this rant**. I wanted to show that I'm not totally out of my mind, and that doing all this is actually pretty easy. (It's less than 1000 lines.)
