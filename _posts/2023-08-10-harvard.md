...
tags: 
description: "An unhinged polemic from my evil twin"
...
![student dots](/img/harvard/experiences1.svg)
...
![student dots partitioned](/img/harvard/experiences2.svg)
...
The hardest part of Harvard is *getting in*. Do you think every legacy admit student athlete is a genius?

Say Alice wants to study math but she get rejected from Harvard so she goes to SIU Edwardsville. She struggles for a couple of semesters and then something clicks—she *gets* math and is at the top of the rest of her classes. She does a great research project and several professors say she's the strongest undergrad to come through in years.
...
## Problem #3: Gating mechanisms certainly shouldn't be created by *ax-exempt nonprofits
...
| Condition | Ivy+ overrepresentation |
| --- | --- |
| Top 25% income | 1.8× |
| Top 10% income | 3.3× |
| Top 1% income | 10.1× |
...
Some point out that Ivy+ admission has little income on mean income rank, and suggest that none of this matters. To this, I have three counterarguments:
...
Second, we don't have causal estimates for things like becoming a CEO or working at the NYT or becoming a senator. But come on—the causal impacts are strongly correlated with Ivy+ overrepresentation. And Ivy+ grads are just as overrepresented among Senators / NYT journalists / presidents as they are among people who go to elite grad schools.
