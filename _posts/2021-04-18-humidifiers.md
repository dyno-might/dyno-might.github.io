...
The evidence for this is [strong](/air). Outdoor particle levels vary throughout the world and statistics link these levels to health problems including heart disease, strokes, kidney disease, respiratory infections, and lung cancer. The mechanism appears to be that tiny particles make their way through the lungs into the bloodstream. These particles then activate the immune system causing all sorts of havoc. The idea that particles cause health problems is widely accepted [(Wu et al, 2021)](https://doi.org/10.3389/fpubh.2021.740800).

A good heuristic is that an increase of 33.3 PM<sub>2.5</sub> μg/m³ costs around 1 disability-adjusted life year. [Correia et al. (2013)](https://dx.doi.org/10.1097%2FEDE.0b013e3182770237) estimated something close to this from different counties in the US, and more recent data from many different countries [confirm this](https://dynomight.net/air/#a-heuristic-to-quantify-harms). The most polluted cities in the world have levels around 100 PM<sub>2.5</sub> μg/m³.
...
[Sain et al. (2017)](https://doi.org/10.1111/ina.12414) and [Yao et al. (2020)](https://doi.org/10.1016/j.envint.2020.105902) observe that different municipal water systems have levels of dissolved solids that can vary by a factor of 10. They find that the purer water creates about half the particles and using deionized water reduces particles by another factor of ⅔. {% comment %} (They also find that "hard water" with high levels of calcium creates slightly fewer particles because the calcium tends to deposit in the reservoir.) {% endcomment %}

[Lau et al. (2020)](https://doi.org/10.1111/ina.12765) compare tap water, filtered water, distilled water, and deionized water. They find that filtered water reduces particles by around 20%, distilled water by 82%, and deionized by 90%.

[Umezawa et al. (2013)](https://doi.org/10.1186/1743-8977-10-64) compare tap water and [ultrapure water](https://en.wikipedia.org/wiki/Ultrapure_water), a type of water that's typically used to make semiconductors, and is even purer than deionized water. They find that ultrapure water creates *no* detectable particles.

## Counterargument: Different particles

Some types of particles are surely more dangerous than others. To take an extreme example, 100 μg/m³ of [asbestos](https://en.wikipedia.org/wiki/Asbestos) is a *lot* worse than 100 μg/m³ of calcium.
...
Most of the above experiments miss a big potential concern with ultrasonic humidifiers: Bacteria and fungus buildup happen within days, and once they've taken hold, they are almost impossible to fully remove. This was shown by [Grieble et al. (1970)](https://doi.org/10.1056/nejm197003052821003) who concluded that daily sterilization was the only way to avoid the problem. Recent research ([Yang et al., 2021](https://doi.org/10.1111/ina.12964) [Tyndall et al., 1995](https://doi.org/10.1111/j.1600-0668.1995.t01-1-00003.x), [Suda et al., 1995](https://doi.org/10.1378/chest.107.3.711)) came to similar conclusions.
...
[Crane](http://pdf.lowes.com/useandcareguides/854689001298_use.pdf):
...
[Levoit](https://cdn.accentuate.io/4847302901848/1617084409190/02.04_ML_HOHIHC11EL_LV600HH_Hybrid-Ultrasonic-Humidifier-(EN_DE)-WEB.pdf?v=0):

> **Only** fill the water tank with distilled water. **Never** fill the water tank with any other liquids.
> [...]
> You should clean the humidifier every 3 days. Change the water every day or every other day to avoid bacteria growth. [...] Fill the tank with 710 mL /
3 cups of distilled white vinegar. Replace the cap and gently shake to coat all sides of the water tank. Allow it to sit for at least 1 hour.

[Honeywell](https://www.honeywellstore.com/store/images/pdf/Honeywell-HUL570-Top-Fill-Cool-Mist-Humidifier-Manual.pdf):

> To keep your humidifier running efficiently, clean it regularly. Weekly cleaning is recommended. [...] Mix 1 gallon (3.8L) of water with 1 teaspoon of bleach. Pour the bleach solution into the Tank.
> [...]
> If you live in a hard water area, the use of distilled water or a demineralization cartridge with tap water will help minimize the production of white dust.

[Sylvane](https://s3-assets.sylvane.com/media/documents/products/owners-manual-sharper-image-uht1-ultrasonic-humidifier.pdf):
...
[Sunbeam](https://www.sunbeam.ca/on/demandware.static/-/Sites-sunbeam-ca-Library/default/dw7e79d94b/documents/instruction-manuals/SUL001W-CN_EN.pdf):
...
That's not *that* much, but it's the same order of magnitude as the benefit of [taking statins](/statins). If the only alternative were dry air, I can see how you might just take the hit. But when the alternative is to buy a different type of humidifier...