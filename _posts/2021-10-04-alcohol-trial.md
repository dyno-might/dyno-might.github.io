...
Following this meeting in July, representatives from the [ICAP](https://en.wikipedia.org/wiki/International_Alliance_for_Responsible_Drinking) and [DISCUS](https://www.distilledspirits.org/) (industry groups, ICAP is now IARD), [Diago](https://en.wikipedia.org/wiki/Diageo) (the world's largest distiller), and [AB InBev](https://en.wikipedia.org/wiki/AB_InBev) (the world's largest brewer) sent Mukamal a detailed list of concerns about the design of an RCT. In August, Mukamal gives a [7-page](mukamal-response.pdf) response responding to all concerns in detail.
