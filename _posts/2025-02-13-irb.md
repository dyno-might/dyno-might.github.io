...
In this post, I'll give the answer and then explain—in maddening detail—why I think it's right. But first I want to tell a little story.
...
I know what you're thinking. "That can't be right! The government can't possibly claim to regulate what me and my roommates eat at home! That would be stupid!" Yes, it *would* be stupid. But who says the world makes sense?
...
*Caution*: I estimate a 85% chance that this post contains at least one minor error and a ~~40%~~ 25% (lowered after surviving thousands of readers) chance of a significant error. I've gone to insane lengths to try to get things right—I regret ever becoming interested in this topic—but this stuff is insanely convoluted.
...
For one, few federal rules actually come from *laws*. Usually politicians pass some broad law that says, "Human research is hereby regulated, details to come!" Then, government employees write *regulations* that contain all the details, and those regulations have the power of law. Later, government employees issue "clarifications" that supposedly don't change anything, but everyone treats like new laws.
...
Finally, the limits of federal power are only clarified when someone fights them in court. Did you know that at some point, bureaucrats decided that your boss must [guess your race and report it to the government](https://dynomight.net/2021/01/15/eeo/)? Is that an illegal overreach? Is it "regulating commerce" to make personal consumption of cannabis illegal in states that have legalized it? The way you find out is you break the rules, get prosecuted, and spend millions fighting in court. (For cannabis, [yes](https://en.wikipedia.org/wiki/Gonzales_v._Raich), that *is* regulating commerce.) If you win, OK, no refunds on your legal fees. If you lose, you pay massive fines or go to prison. Also, courts have constantly changing judges and opinions.

So what happens in practice is politicians write a vague law. Bureaucrats turn that law into very detailed (but often simultaneously vague) specific rules. Those rules might or might not be "legal", but nobody wants to risk fighting them in court. If the regulations are particularly ridiculous or likely to be overturned if challenged, prosecutors may quietly decline to bring cases. But the regulations still sit there on the books. And people still usually pay attention to them, because why risk it?

OK! Where do IRB regulations come from?

## The Common Rule

In 1932, the United States government and Tuskegee University began studying 600 poor black sharecroppers in Macon County Alabama, ⅔ of whom had latent syphilis. The idea was to observe the progression of the disease if left untreated. By the late 1940s, syphilis was easily treatable with penicillin, but the men were never informed of their condition, never treated, and were even given fake treatments and diagnoses.
...
It also led, in early 1973, to a series of congressional hearings led by [Ted Kennedy](https://en.wikipedia.org/wiki/Ted_Kennedy) of Massachusetts. These hearings eventually produced the [National Research Act](https://en.wikipedia.org/wiki/National_Research_Act). Several people voted for [the first version](https://www.govtrack.us/congress/votes/93-1973/s382) of this bill and then against the [second version](https://www.govtrack.us/congress/votes/93-1974/s865), including one Joseph Biden of Delaware, though I can't find any record of why. It was signed into law by Richard Nixon on July 12, 1974.
...
Note that this applies to all types of research. The people who made these rules were almost all medical researchers thinking about serious medical risks. But they wrote the rules to apply to *all* research, including research where you might just ask people some questions.
...
That's a real quote that you can go read on the [Health and Human Services website](https://www.hhs.gov/ohrp/education-and-outreach/luminaries-lecture-series/belmont-report-25th-anniversary-interview-cmccarthy/index.html#:~:text=But%20we%20were%20trying) today.
...
But how could a MIT *employee* do research without involving MIT *personnel*? The closest I can find to anyone saying it's OK to do independent research without an IRB is [Columbia University](https://research.columbia.edu/sites/default/files/content/HRPO/IRB_SOP_v5.2_2.12.19_TOC_CUIMC.176a.9.12.19.pdf) which says an IRB is needed if:
...
OK! So if you're doing any research at any federally funded institution, you need an IRB. If you work at such an institution, you could *maybe* do research at home, if your institution is easy-going, the research is unrelated to your job, and you're willing to live dangerously.
...
I've seen some people claim that California also requires IRB approval for all human subjects research. But as far as I can tell, this is wrong. While California has some [extra regulations](https://leginfo.legislature.ca.gov/faces/codes_displayText.xhtml?lawCode=HSC&division=20.&title&part&chapter=1.3.&article) for research, none of them seem to require IRB approval.
...
So what do the FDA regulations say? I found them to be much more painful to read than the (already very painful) Common Rule regulations. But after much thrashing and screaming, I think the core regulation is [21 CFR 56.103(a)](https://www.ecfr.gov/current/title-21/part-56/section-56.103#p-56.103(a)):
...
So what does this mean? Well, a "clinical investigation" is defined by [21 CFR 56.102(c)](https://www.ecfr.gov/current/title-21/part-56#p-56.102(c)) to be anything involving human subjects and a "test article". And a "test article" is defined in turn by [21 CFR 56.102(l)](https://www.ecfr.gov/current/title-21/part-56#p-56.102(l)) to be any "drug" for human use. So if you're doing anything with a "drug" that requires "prior submission", then you need an IRB. What do *those* terms mean? [21 CFR Part 312](https://www.ecfr.gov/current/title-21/part-312) makes clear that "prior submission" is referring to an investigational new drug (IND) application to the FDA.

(Caution: An "IRB" and an "IND" are different things. An IRB is what this article is about. An [IND](https://en.wikipedia.org/wiki/Investigational_New_Drug) is the kind of application that pharmaceutical companies make to the FDA before they can start clinical trials.)

So, at first, this seems like good news: As long as you don't need to do a (gigantic, extremely expensive) IND application to the FDA before starting your research, then FDA regulations don't force you to use an IRB. Whew! Except... When are you supposed to do an IND? Surely that's not some incredibly broad set of circumstances that apply to almost anything, is it?
...
If you want to avoid an IND, your best hope is that your research doesn't involve a "drug". Unfortunately, the term "drug" is defined extremely broadly, way beyond the colloquial meaning of "drug" in English. A drug is defined as:
...
Now, I know what you're thinking. "That can't be right! That would mean that if I wanted to study if some normal food reduced the odds of diabetes, then I wouldn't just need IRB approval, I'd need to submit a freaking *IND*! That would be stupid!"
