...
I wrote about this [back in 2022](https://dynomight.net/prediction-market-causation/), but my argument was kind of sprawling and it seems to have failed to convince approximately everyone. So thought I'd give it another try, with more aggression. [Edit: See also [this post](https://www.lesswrong.com/posts/xnC68ZfTkPyzXQS8p/prediction-markets-are-confounded-implications-for-the) from Anders_H in 2015, which is the earliest ]
