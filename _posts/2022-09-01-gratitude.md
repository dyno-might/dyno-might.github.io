...
And [this](https://www.wsj.com/articles/is-the-secret-to-happiness-having-a-gratitude-practice-11642691301){: rel="nofollow"}:
...
Along with the different types of happiness, they also measured traits like positive/negative affects, the Big Five personality traits, and conditions like anxiety and depression. Here were their results:

| Trait                   | Correlation with gratitude |
| ------------------------------------- | -------------------------- |
| life satisfaction, vitality, subjective happiness, optimism       | around 0.5                       |
| positive affect                             | around 0.3                       |
| Big Five traits of agreeableness, conscientiousness, extraversion, emotional stability, and openness                     | around 0.16                       |
| anxiety and depression                       | around -0.2                       |
...
| Type of positive well-being                   | Correlation with gratitude |
| ------------------------------------- | -------------------------- |
| Subjective well-being composite       | 0.43                       |
| Happiness                             | 0.45                       |
| Life Satisfaction                     | 0.48                       |
| Positive affect                       | 0.40                       |
| Psychological well-being composite    | 0.46                       |
| Self-focused psychological well-being | 0.44                       |
| Other psychological well-being        | 0.47                       |

There are lots of different ways to define/measure happiness, but they all have correlations that are pretty close to the average of 0.42. Similarly, all the different types of *un*happiness are negatively correlated with gratitude:

| Type of negative well-being | Correlation with gratitude |
| ------------------- | -------------------------- |
...
![gratitude <-> all blue <-> happiness <-> gratitude](/img/gratitude/3-way2.svg)
...
<details markdown="1">
<summary>You might conclude that gratitude doesn't tell you much once you know the Big Five. That is... not how Wood et al. see things:</summary>


They did a regression of the Big Five on each of six different types of happiness.  Then they added gratitude as a feature, and did another set of regressions. Here are the specific results for each type of happiness:

|                        | % variance explained (Big five only) | % variance explained (big five + gratitude) |
| ---------------------- | ------------------------------------ | ------------------------------------------- |
| Autonomy               | 40%                                  | 40%                                         |
| Environmental mastery  | 62%                                  | 62%                                         |
| Personal growth        | 54%                                  | 60%                                         |
| Positive relationships | 54%                                  | 56%                                         |
| Purpose in life        | 46%                                  | 48%                                         |
| Self-acceptance        | 62%                                  | 68%                                         |

To be fair, their sample was large enough that they found statistical significance for the difference in 4 of the 6 types of happiness. But come on: The magnitude of the increase is pretty small. Unless a feature is completely useless it will *always* provide some uplift in accuracy, and this will be statistically significant with enough data. That doesn't mean it's *practically* significant.
...
[Davis et al. (2016)](https://doi.org/10.1037/cou0000107) did a meta-analysis that broke down experiments based on their control groups. The **measurement-only** control groups simply evaluated their happiness without doing any activity. In these, the average effect size was 0.31. Meanwhile, the **alternate activity** control groups did another activity in place of gratitude exercises, such as listing hassles, feelings, or life events. In these experiments, the average effect size was 0.16.
</details>
...
[![effect sizes of gratitude exercises](/img/gratitude/gratitude-effect-sizes.svg)](/img/gratitude/gratitude-effect-sizes.pdf)
...
Gratitude exercises look amazing when compared to negative interventions. But the benefits shrink greatly when compared to neutral interventions, and even further when compared to positive interventions.
 ...
 Here is the same figure again, with the number of studies contributing to each effect added:

[![effect sizes of gratitude exercises with numbers of studies](/img/gratitude/gratitude-effect-sizes-nums.svg)](/img/gratitude/gratitude-effect-sizes-nums.pdf)

Some of these bars are based on a very small number of studies, particularly some of the massive effects compared to negative interventions.
</details>
...
![study size vs effect size Sin and Lyubomirsky](/img/gratitude/sin1.png){: width='400' }
...
![study size vs effect size Bolier](/img/gratitude/bolier1.png){: width='400' }

And here's the funnel plot:

![funnel plot Bolier](/img/gratitude/bolier2.png){: width='400' }

Here, correcting for publication bias drives the estimated effect almost to zero.
...
## FAQ
{% include faq.html content="Does gratitude practice improve your physical health? => There is no evidence for this. [Dickens et al. (2017)](https://doi.org/10.1080/01973533.2017.1323638) did a meta-analysis of this issue. Compared to negative controls (3 studies) or neutral controls (5 studies), gratitude exercises did almost nothing for physical health. Compared to positive controls (3 studies) gratitude had a small *negative* effect. But I wouldn't take this too seriously, it's probably just noise. && Does gratitude practice improve your sleep? => There is no evidence for this. [Dickens et al. (2017)](https://doi.org/10.1080/01973533.2017.1323638) found that compared to both negative controls (3 studies) and positive controls (2 studies) gratitude had essentially no effect on sleep. && Does gratitude practice improve the quality of your relationships? => Unclear. Compared to neutral interventions (4 studies) [Dickens et al. (2017)](https://doi.org/10.1080/01973533.2017.1323638) found quite a fairly large effect size of 0.51 on relationship quality. However, when compared to positive interventions (2 studies) the effect size was exactly zero." %}
