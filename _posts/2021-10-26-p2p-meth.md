...
The Drug Enforcement Agency tests the meth they seize to see how it was made. Here's their [data](https://www.dea.gov/sites/default/files/2018-07/DIR-001-17_2016_NDTA_Summary.pdf) starting in 2009, where you can see that P2P synthesis (in red) rapidly displaces the older ephedrine-based phosphorus-iodine synthesis (in blue).
...
For many complex molecules, you could take the atoms, and "flip" them to get another stable version of the same molecule, called an [isomer](https://en.wikipedia.org/wiki/Isomer) or [enantiomer](https://en.wikipedia.org/wiki/Enantiomer). These different versions of the molecule can have very different effects on the body.
...
Unfortunately, I can't seem to find any data going back further to before when P2P meth was introduced. It's likely that d-meth was higher before 2009, though [this paper](https://doi.org/10.1002/dta.3117) analyzes meth in Australia, and finds that for some reason, ephedrine-based meth often has fair amounts of l-meth, too.
...
Modern street meth is extremely pure, something on the order of 97% d-meth. Such pure meth was probably never available before.
...
* Starting around 2009, people started to make P2P using ethyl phenylacetate (EtPA).
* Then, starting around 2014, it became more common to create nitrostyrene (NTS) and then convert it into P2P.
* Starting in 2018, there was a shift to an old method based on phenylaceticacid (PAA).

It's much messier than this implies: The transitions were gradual, all the methods (EtPA, NTS, PAA) have variants, and the DEA finds a fair number of "unknown" samples each year that they can't classify.

On top of these different methods to make P2P, there are [different methods](https://www.erowid.org/archive/rhodium/chemistry/meth.louisfreeh.html) to convert P2P into meth, and these have probably changed over time as well. The DEA seems to attribute most impurities to the P2P production step. However, they don't seem very interested in how impurities might affect the health of users---they are mostly just interested in how to disrupt the supply chain.
...
We can put these numbers in context with some arithmetic.

Let's compare to someone who takes amphetamines/Adderall for ADHD, typically prescribed 10-30 mg per day. A [strong dose of meth](https://erowid.org/chemicals/meth/meth_dose.shtml) is 40-150 mg, while an [addict](http://dx.doi.org/10.1300/J069v21n01_04) might take 300-800mg per day. On top of this, people say that meth is around 2× as potent as amphetamines. So meth addicts are taking around **25×** the dose of a typical person prescribed Adderall.

That's a lot, but let's talk about overdoses. It's actually pretty hard to overdose on meth. [This paper](https://dx.doi.org/10.1016%2FS0074-7742(09)88004-5) says that 50% of rats and mice die at a dosage of around 55 mg/kg. This suggests that an 80 kg (175 lb) person would need to take 4400 mg of meth to die. That's roughly **500×** a clinical dose of Adderall.
...
First, I think it's unlikely that l-meth is causing people to go crazy. Modern P2P meth is nearly pure d-meth, and the percentage of l-meth peaked in 2011, before these reports of schizophrenia.

Second, the evidence we have is against the idea of contaminants in P2P meth. Almost all meth was produced using P2P since 2012, way before these reports of schizophrenia. And P2P meth synthesis has changed several times in the interim, resulting in higher purity than ever before.
