...
* Starting around 2009, people started with using EtPA to make PAA.
* Then, starting around 2014, there was a shift towards using the NTS synthesis.
* Starting in 2018, there was a shift back towards using PAA. (It's not clear if this PAA was sourced directly, or made from EtPA or in some other way.)
...
This history of synthesis methods does not support the theory that lead acetate in meth is causing schizophrenia: Lead acetate was used much less between 2014 and 2018 when NTS synthesis mostly displaced PAA synthesis. This doesn't correlate with reports of schizophrenia at all, which seem unrelated to synthesis methods.
