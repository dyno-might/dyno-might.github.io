...
Here's data from the DEA again, where "potency" is the percentage of d-meth among all meth (assembled from the National Drug Threat reports from many different years):
