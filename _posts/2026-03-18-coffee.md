...
You can find the data in CSV format [here](/img/coffee/data.csv). The first column is the elapased time in `MM:SS` format, the second column is the elapsed time in minutes, and the third column is the measured temperature.
