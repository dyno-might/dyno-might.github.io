...
<div class="container" style="text-align: center; border-style:solid; border-width:0px; padding:10px; background-color:#888888" id="form"> 
  <form action="https://formsubmit.co/4a18e703496d7ca33c417b1bf528ad9d" method="POST"> 
    <div class="headerfont" style="color:white; margin-bottom:2px; padding:5px; font-size:110%;"></div> 
    ...
    <button type="submit" class="headerfont" style="color:white; border-width:0px; margin:0; padding:0; background-color: transparent;">OK WHATEVER</button> 
    </span>
  </form>
</div>   
<br>
