...
3. What's a good strategy? If Alex is worried about breast cancer, should she help with prevention or early diagnostics or basic research?
...
This isn't anyone's fault! It's not Alex's fault for not doing this basically-impossible research, and it's not an organization's fault for being good at the one thing they must be good at to not be outcompeted by an organization that *is* good at it. It's just another case where [nature imposes a fitness function that isn't aligned with our interests](/evolution).
...
* [Why indoor lighting is hard to get right and how to fix it](https://www.lesswrong.com/posts/7izSBpNJSEXSAbaFh/why-indoor-lighting-is-hard-to-get-right-and-how-to-fix-it) by Richard Korzekwa

* [Things that sometimes help if you have depression](https://slatestarcodex.com/2014/06/16/things-that-sometimes-help-if-youre-depressed/) and [Things that sometimes work if you have anxiety](https://slatestarcodex.com/2015/07/13/things-that-sometimes-work-if-you-have-anxiety/)  by Scott Alexander
